...
function buildCopy(lang: Lang) {
  return lang === "en"
    ...
    : {
        ...
        subtitle: "Données exactes utilisées dans le calcul du match.",
        labels: {
          thesis: "Thèse",
          stage: "Stade",
          ticket: "Ticket",
        ...
        rows: {
          startupSector: "Secteur startup",
          fundSectors: "Secteurs fonds",
          startupStage: "Stade startup",
          fundStages: "Stades fonds",
          amountSought: "Montant recherché",
          fundRange: "Range de ticket du fonds",
          listedDeals: "Investissements listés",
          detectedSignals: "Signaux détectés",
          source: "Source du signal",
          noDeals: "Aucun investissement nommé dans le dataset actuel.",
          noSignals: "Aucun recouvrement clair détecté dans le narratif de la startup.",
          sourceText: "Dérivé de la description, de la thèse et des investissements notables stockés dans Alfred.",
        },
        summaries: {
          thesis: {
            exact: "Match secteur exact",
            strong: "Chevauchement fort de thèse",
            broad: "Mandat large seulement",
            weak: "Secteur décalé",
          },
          stage: {
            exact: "Match stade exact",
            adjacent: "Stade adjacent",
            broad: "Souple mais indirect",
            weak: "Stade hors range",
          },
          ticket: {
            inside: "Dans le range",
            near: "Proche du range",
            stretch: "Range étiré",
            outside: "Hors range",
          },
          portfolio: {
            high: "L'historique soutient le match",
            medium: "Support historique partiel",
            low: "Support historique limité",
          },
        },
      };
}
